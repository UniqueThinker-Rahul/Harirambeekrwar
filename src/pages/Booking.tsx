    ...
    return (
      <div className="min-h-screen bg-light-grey flex items-center justify-center p-4">
        <div className="bg-white p-10 rounded-3xl shadow-xl border border-gray-100 text-center max-w-md w-full">
          ...
          <button onClick={() => setStatus("idle")} className="bg-green-600 text-white px-8 py-4 rounded-full font-bold hover:bg-green-700 transition-colors w-full shadow-md">Book Another Session</button>
        </div>
      </div>
    );
  }
            ...
            <div className="lg:col-span-2 bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
              <div className="p-8 md:p-12">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* Button color changed to green */}
                  <button disabled={status === "loading"} type="submit" className="w-full bg-green-600 text-white font-bold text-xl py-5 rounded-full hover:bg-green-700 transition-all shadow-xl disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center transform hover:-translate-y-1">
