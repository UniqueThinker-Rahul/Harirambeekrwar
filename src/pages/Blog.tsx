...
const Blog = () => (
  <>
    <SEO 
      title="Cosmic Wisdom Blog | numerology Insights" 
      description="Read the latest articles on Vedic numerology, Vastu tips, numerology, and cosmic energy by Hari ram Beekrwar."
    />
    <div className="min-h-screen py-20 px-4 bg-light-grey">
      <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-medium-grey text-lg mb-12 max-w-2xl mx-auto">Stay updated with the latest numerological transits, Vastu tips, and spiritual life hacks to continuously improve your energy.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  <p className="text-xs text-primary font-bold mb-3 tracking-widest uppercase">Numerology</p>
