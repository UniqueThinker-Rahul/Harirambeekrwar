...
const About = () => {
  return (
    <>
      <SEO 
        title="About HARIRAM BEEKRWAR | Master Vedic Astrologer" 
        description="Learn more about Hariram Beekrwar, a master Vedic astrologer and Vastu expert with over 20 years of experience shaping thousands of lives globally."
      />
      <div className="bg-light-grey min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <Link to="/booking" className="inline-flex justify-center items-center px-10 py-5 rounded-full bg-dark-grey text-white font-bold text-lg hover:bg-secondary transition-all shadow-lg hover:-translate-y-1 w-full sm:w-auto">
                  Consult Hariram Beekrwar Today <Star className="w-5 h-5 ml-2 fill-current text-primary" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-light-grey">
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl text-medium-grey max-w-3xl mx-auto mb-16">Here is exactly why thousands of people choose Hariram Beekrwar over generic unverified astrologers.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                 ...
                 <div className="bg-white p-10 rounded-3xl shadow-sm text-left">
                    ...
                    <p className="text-medium-grey leading-relaxed text-lg">We advocate for behavioral modifications, color therapy, and simple household routines. We will never ask you to perform excessively costly rituals.</p>
                 </div>
              </div>
           </div>
        </section>
