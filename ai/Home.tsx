  ...
  return (
    <>
      <SEO 
        ...
        keywords="Numerology, Vastu Shastra, Hari ram Beekrwar, numerology consultation"
      />
      <div>
        {/* Hero Section */}
        <section className="relative bg-dark-grey text-white overflow-hidden py-24 sm:py-32 layout-section">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
            ...
            >
              Welcome! I am Hari ram Beekrwar. I believes that every individual carries a unique energy, and when that energy is aligned with the right numbers and surroundings, extraordinary growth becomes possible.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                 ...
                 <div className="md:w-1/2">
                    ...
                    <p className="text-medium-grey text-lg mb-6 leading-relaxed">
                       With over 5 years of rich experience in the mystical science of energies, I have successfully guided more than 2,200 clients worldwide. My mission is simple: to decode the hidden patterns of your life using numbers and to optimize your surroundings using the ancient wisdom of Vastu Shastra.
                    </p>
                    ...
                    <ul className="space-y-4 mb-8">
                       <li className="flex items-start"><CheckCircle className="w-6 h-6 text-primary mr-3 shrink-0" /> <span className="text-dark-grey font-medium">5+ Years of Professional Experience.</span></li>
        ...
        <section className="py-24 bg-light-grey">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Changed from md:grid-cols-3 to md:grid-cols-2 so the two items fill the space properly */}
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                 ...
                 {[
                    ...
                    { step: "02", icon: <Users className="w-8 h-8" />, title: "Private Consultation", desc: "Speak directly with Hari ram Beekrwar safely and confidentially." },
