...
const ServiceDetail = () => {
  ...
  const title = slug ? slug.replace(/-/g, ' ') : 'Numerology Service';
      ...
      <div className="min-h-[70vh] bg-light-grey pb-24 text-dark-grey">
        ...
        <div className="max-w-4xl mx-auto px-4 -mt-10">
          <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100">
            ...
            {/* Split layout for image and description */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
               <div>
                  <img src="/Resource/image_9e22c5.jpg" alt="Numerology Analysis" className="rounded-2xl shadow-lg w-full h-[350px] object-cover mb-6" />
               ...
               <div className="flex flex-col gap-8">
                  <div>
                    <h3 className="text-2xl font-bold text-dark-grey mb-4 border-b pb-2">Session Benefits</h3>
                  ...
                  <div className="bg-yellow-50 p-6 rounded-2xl border border-yellow-100">
                    ...
                    <div className="flex items-center text-medium-grey mb-3">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-medium-grey mb-2">Spots fill up extremely fast.</p>
